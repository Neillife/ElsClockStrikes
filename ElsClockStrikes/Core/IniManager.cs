...
namespace ElsClockStrikes.Core
{
    public class IniManager
    {
        ...
        public void LoadDefault()
        {
            ...
            this.SetValue(FormsConstant.config127R3SectionName, "小荊棘音量TextBox", "100");
            this.SetValue(FormsConstant.config127R3SectionName, "小荊棘分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config127R3SectionName, "雷射音量TextBox", "100");
            this.SetValue(FormsConstant.config127R3SectionName, "雷射分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config127R3SectionName, "荊棘延遲音量TextBox", "100");
            this.SetValue(FormsConstant.config127R3SectionName, "荊棘延遲分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config127R3SectionName, "控場音量TextBox", "100");
            this.SetValue(FormsConstant.config127R3SectionName, "控場分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R1SectionName, "大招音量TextBox", "100");
            this.SetValue(FormsConstant.config156R1SectionName, "大招分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R1SectionName, "大刺音量TextBox", "100");
            this.SetValue(FormsConstant.config156R1SectionName, "大刺分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R1SectionName, "翻桌音量TextBox", "100");
            this.SetValue(FormsConstant.config156R1SectionName, "翻桌分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R1SectionName, "R1156控場音量TextBox", "100");
            this.SetValue(FormsConstant.config156R1SectionName, "R1156控場分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R3SectionName, "大黑音量TextBox", "100");
            this.SetValue(FormsConstant.config156R3SectionName, "大黑分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R3SectionName, "陰陽陣音量TextBox", "100");
            this.SetValue(FormsConstant.config156R3SectionName, "陰陽陣分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R3SectionName, "三連音量TextBox", "100");
            this.SetValue(FormsConstant.config156R3SectionName, "三連分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.config156R3SectionName, "R3156控場音量TextBox", "100");
            this.SetValue(FormsConstant.config156R3SectionName, "R3156控場分離視窗CheckBox", "False");
            ...
            this.SetValue(FormsConstant.configCustomizeSectionName, "CustomizeVolumeList", "");
            this.SetValue(FormsConstant.configCustomizeSectionName, "CustomizeFormInstanceList", "");
            this.SetValue(FormsConstant.configCustomizeSectionName, "CustomizeFormInstancePosKeyList", "");
            this.SetValue(FormsConstant.configCustomizeSectionName, "CustomizeFormInstancePosValueList", "");
            ...
            this.SetValue(FormsConstant.configGlobalSectionName, "BaseMechanicFormInstancePosKeyList", "");
            this.SetValue(FormsConstant.configGlobalSectionName, "BaseMechanicFormInstancePosValueList", "");
            this.Save();
        }
